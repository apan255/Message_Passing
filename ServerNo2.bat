...
echo SERVER-2 
echo *************************************************************************
".\Message\Debug\ExecutiveServer.exe" "COMMAND:UploadFile" "SRCIP:localhost" "SRCPORT:9100" "FILENAME:.\\TEST_Folder\\Messa.cpp" "FILETYPE:binary" "DSTIP:localhost" "DISPORT:9091"
