...
echo *************************************************************************
echo Demonstrating project requirement 3, 5 and 7 with transporting binary (testImage.png)
echo  and text files (TestDoc.txt)  
echo    
...
echo     Client2 sends a binary file testImage.png to Server1 and Server2 and receives acknowledgement back
