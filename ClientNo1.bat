...
echo CLIENT-1
echo *************************************************************************
".\Message\Debug\ExecutiveClient.exe" "COMMAND:UploadFile" "SRCIP:localhost" "SRCPORT:8081" "FILENAME:.\\TEST_Folder\\TextDoc.txt" "FILETYPE:binary" "DSTIP:localhost" "DISPORT:8484"
