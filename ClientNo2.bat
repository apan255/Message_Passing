...
echo     Client2 sends a binary file testImage.png to Server1 and Messa.cpp Server2 and receives acknowledgement back
...
echo CLIENT-2 
echo *************************************************************************
".\Message\Debug\ExecutiveClient.exe" "COMMAND:UploadFile" "SRCIP:localhost" "SRCPORT:9091" "FILENAME:.\\TEST_Folder\\Messa.cpp" "FILETYPE:binary" "DSTIP:localhost" "DISPORT:8484" "DISPORT2:9100"